...
export default class HTML extends PureComponent {
    ...
    componentDidMount () {
        this.registerDOM();
      this.onDOMImagePressSubscribe = DeviceEventEmitter.addListener('onDOMImagePress', (e) => {
        if (this.props.onDOMImagePress) {
          this.props.onDOMImagePress(e)
        }
      })
    }

  componentWillUnmount () {
      if (this.onDOMImagePressSubscribe) {
        try {
          this.onDOMImagePressSubscribe.remove()
        } catch (e) {
        }
      }
  }
